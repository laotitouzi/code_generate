...
public class CommonPageParser
{
  ...
  static
  {
    try
    {
      String templateBasePath = "C:/t_workspace/code_generate/src/main/resources/template";// CommonPageParser.class.getClassLoader().getResource("")+ CodeGenerateFactory.getTempletePath(); /* "/resources/cengle/template"*/;
